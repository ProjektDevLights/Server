...
export class ColorsService {
    ...
    async updateLedsWithTag(tag: string, data: UpdateLedsDto): Promise<StandartResponse<Light[]>> {
        ...
        if (isEqual(oldLights, newLights)) {
            throw new NothingChangedException("The color of the lights with this tag didn't change!");
        }
